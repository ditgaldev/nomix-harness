...
| --- | --- | --- | --- |
| `@nomix-ai/cosmokit` | `cosmokit` | [github.com/nomix-harness/cosmokit](https://github.com/nomix-harness/cosmokit) | MIT |
| `@nomix-ai/schemastery` | `schemastery` | [github.com/nomix-harness/schemastery](https://github.com/nomix-harness/schemastery) | MIT |
...
| `@nomix-ai/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/nomix-harness/cordis](https://github.com/nomix-harness/cordis) | MIT |
| `@nomix-ai/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/nomix-harness/cordis](https://github.com/nomix-harness/cordis) | MIT |
| `@nomix-ai/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/nomix-harness/cordis](https://github.com/nomix-harness/cordis) | MIT |
| `@nomix-ai/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/nomix-harness/cordis](https://github.com/nomix-harness/cordis) | MIT |
| `@nomix-ai/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/nomix-harness/cordis](https://github.com/nomix-harness/cordis) | MIT |
