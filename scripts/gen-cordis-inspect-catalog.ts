...
import type { CordisCatalogModel, ServiceMethodEntry } from '@nomix-ai/nomix-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@nomix-ai/nomix-tool-cordis/api-catalog', '@nomix-ai/nomix-cordis-client-runner/client/api-catalog')
