...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@nomix-ai/nomix-typert-generator'
import type { CordisCatalogPolicy } from '@nomix-ai/nomix-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@nomix-ai/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  nomixHomePath: 'not a service: boot-provided root accessor function (typeof nomixHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
 ...
 * scan reads EVERY `declare module '@nomix-ai/cordis'` Events merge under
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  NomixEnvironment: 'subprocess.md',
