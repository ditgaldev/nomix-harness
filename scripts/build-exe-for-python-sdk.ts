...
const DEPLOY_ROOT_PACKAGE = 'nomix-jsonrpc-agent-pkg'
/** The closed-runtime app entry inside the deployed closure. */
const ENTRY_BIN = 'node_modules/@nomix-ai/nomix-sdk-jsonrpc-demo/lib/packaged-bin.js'
const OUTPUT_BASENAME = 'nomix-jsonrpc-agent-pkg'
...
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/nomix_harness_runtime/runtime'
