...
const REPOSITORY_URL = 'https://github.com/ditgaldev/nomix-harness'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/ditgaldev/nomix-harness/${repositoryRef}/${path}${suffix}`
