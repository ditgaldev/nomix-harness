...
import type { ToolSchema } from '@nomix-ai/nomix-llm'
import AgentRegistry from '@nomix-ai/nomix-agent'
import type { Agent } from '@nomix-ai/nomix-agent'
import { createScope } from '@nomix-ai/nomix-scope'
...
import SqliteSessionQueryEngine from '@nomix-ai/nomix-session-query-sqlite'
import GoalService from '@nomix-ai/nomix-goal'
import SystemPrompt from '@nomix-ai/nomix-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@nomix-ai/nomix-tools'
import LocalBashExecutor from '@nomix-ai/nomix-bash-local'
import * as BashEnvPlugin from '@nomix-ai/nomix-shell-env'
import { PwshLocalExecutor } from '@nomix-ai/nomix-pwsh-local'
...
import PlanModeController from '@nomix-ai/nomix-plan-mode'
import WebRuntime from '@nomix-ai/nomix-web'
import * as WebSearchExa from '@nomix-ai/nomix-web-search-exa'
import * as WebFetchLocal from '@nomix-ai/nomix-web-fetch-http'
import SubagentRuntime from '@nomix-ai/nomix-subagent'
import type { SubagentProvider, SubagentReportDelivery } from '@nomix-ai/nomix-subagent'
import * as ToolSubagentControl from '@nomix-ai/nomix-tool-subagent-control'
import * as ToolSubagentListAgents from '@nomix-ai/nomix-tool-subagent-control/list-agents'
import * as ToolSubagentReport from '@nomix-ai/nomix-tool-subagent-report'
import SkillRegistry from '@nomix-ai/nomix-skill'
import * as SkillFileSystem from '@nomix-ai/nomix-skill-filesystem'
import LocalJobRegistry from '@nomix-ai/nomix-jobs-local'
import * as ToolAskUser from '@nomix-ai/nomix-tool-ask-user'
import * as ToolBash from '@nomix-ai/nomix-tool-bash'
import * as ToolPwsh from '@nomix-ai/nomix-tool-pwsh'
import * as ToolBashPersistent from '@nomix-ai/nomix-tool-bash-persistent'
import * as ToolPwshPersistent from '@nomix-ai/nomix-tool-pwsh-persistent'
import CordisHostRunner from '@nomix-ai/nomix-cordis-host-runner'
import * as ToolCordis from '@nomix-ai/nomix-tool-cordis'
import * as ToolFs from '@nomix-ai/nomix-tool-fs'
import * as ToolFsSearch from '@nomix-ai/nomix-tool-fs-search'
import * as ToolStrReplaceEditor from '@nomix-ai/nomix-tool-str-replace-editor'
import TerminalSessionService from '@nomix-ai/nomix-terminal'
import * as ToolPty from '@nomix-ai/nomix-tool-terminal'
import * as ToolGoal from '@nomix-ai/nomix-tool-goal'
import * as ToolSchedule from '@nomix-ai/nomix-schedule'
import Lsp from '@nomix-ai/nomix-lsp'
import * as ToolLsp from '@nomix-ai/nomix-tool-lsp'
import * as ToolSkill from '@nomix-ai/nomix-tool-skill'
import * as ToolSessionQuery from '@nomix-ai/nomix-tool-session-query'
import * as ToolTasks from '@nomix-ai/nomix-tool-jobs'
import type TeamService from '@nomix-ai/nomix-experimental-agent-team'
import * as ToolTeam from '@nomix-ai/nomix-experimental-tool-agent-team'
import * as ToolTodo from '@nomix-ai/nomix-tool-todo'
import * as ToolSubagent from '@nomix-ai/nomix-tool-subagent'
import * as ToolWeb from '@nomix-ai/nomix-tool-web'
import VmWorkflowEngine from '@nomix-ai/nomix-workflow-worker-thread'
import * as ToolRalph from '@nomix-ai/nomix-tool-ralph'
import * as ToolWorkflow from '@nomix-ai/nomix-tool-workflow'
...
const TOOL_PACKAGES: ToolPackage[] = [
  {
    pkg: '@nomix-ai/nomix-tool-ask-user',
    dir: 'tool-ask-user',
  ...
  },
  {
    ...
    note:
      'The bash tool is the model-facing consumer of the bash executor seam. A `run_in_background` run registers with the generic `ctx.jobs` runtime and is collected/stopped through the `job_*` tools from `@nomix-ai/nomix-tool-jobs`; the `enableRunInBackground` config (default true) removes the parameter entirely when disabled.',
  },
  {
    pkg: '@nomix-ai/nomix-tool-pwsh',
    dir: 'tool-pwsh',
    ...
    note:
      'The pwsh tool is the PowerShell-dialect consumer of the bash executor seam for Windows compositions (a PowerShell executor such as `@nomix-ai/nomix-pwsh-local` backs `ctx.shell`); it mirrors the bash tool call-for-call minus sandbox controls — `run_in_background` runs register with the generic `ctx.jobs` runtime and are collected/stopped through the `job_*` tools, and the managed `NOMIX_*` environment comes from `@nomix-ai/nomix-shell-env`. Each call runs in a fresh process (no persistent PTY session), with native `C:\\...` paths and `$env:NAME` variables.',
  },
  {
    pkg: '@nomix-ai/nomix-tool-cordis',
    dir: 'tool-cordis',
    ...
    note:
      'Not in any shipped tree (a deliberate opt-in — dynamic package code reaches the real runtime, see .agents/notes/implemented/feature/2026-07-08-self-referential-cordis-toolset.md). The toolset injects `ctx.dynamicCordisRunner` from `@nomix-ai/nomix-cordis-host-runner`, which owns the definition registry and the vm sandbox; a composition missing it never activates the tools. A running package may register ADDITIONAL model-visible tools until it is stopped, undefined, or NOMIX restarts; a full changed request header logs those tool-set changes.',
  },
  {
    pkg: '@nomix-ai/nomix-tool-bash-persistent',
  ...
  {
    pkg: '@nomix-ai/nomix-tool-pwsh-persistent',
  ...
  {
    pkg: '@nomix-ai/nomix-tool-str-replace-editor',
  ...
  },
  {
    ...
    note:
      'The read-before-write/edit policy is added by `@nomix-ai/nomix-fs-observation-policy` (an `fs/*` event-gate plugin, no schema change); a deployment that loads these tools is expected to also load it. The image tool is not registered without `ctx.attachments`; its schema is route-independent, and execution refuses unless the exact routed model declares image input.',
  },
  {
    pkg: '@nomix-ai/nomix-tool-fs-search',
    dir: 'tool-fs-search',
  ...
  {
    pkg: '@nomix-ai/nomix-tool-terminal',
    dir: 'tool-terminal',
  ...
  },
  {
    ...
    note:
      'The lsp tool keeps provider selection and language-server subprocesses behind ctx.lsp, so its model-visible schema stays stable across providers. Requires a registered provider (e.g. `@nomix-ai/nomix-lsp-stdio`) at runtime; without one, a query returns the structured `LSP_UNAVAILABLE` error rather than changing the schema.',
  },
  {
    pkg: '@nomix-ai/nomix-tool-ralph',
    dir: 'tool-ralph',
  ...
  },
  {
    ...
    async mount(ctx) {
      ...
      await ctx.plugin(SkillFileSystem, {
        nomixHome: resolve(root, '.tmp/tool-catalog/.nomix'),
  ...
  {
    pkg: '@nomix-ai/nomix-tool-session-query',
  ...
  {
    pkg: '@nomix-ai/nomix-tool-subagent',
    dir: 'tool-subagent',
  ...
  {
    pkg: '@nomix-ai/nomix-tool-subagent-control',
  ...
  {
    pkg: '@nomix-ai/nomix-tool-subagent-report',
  ...
  {
    pkg: '@nomix-ai/nomix-experimental-tool-agent-team',
    dir: 'tool-agent-team',
    ...
    scope: ctx => catalogChildScopes.get(ctx) as Agent,
    note:
      'All ten tools are scoped to implicit Team Leads and durable teammates. The shipped nomix-base bundle keeps the package disabled; the documented Agent Teams profile patch enables it while disabling the legacy continuable-child control names.',
  },
  {
    pkg: '@nomix-ai/nomix-tool-todo',
    dir: 'tool-todo',
  ...
  {
    pkg: '@nomix-ai/nomix-tool-workflow',
    dir: 'tool-workflow',
