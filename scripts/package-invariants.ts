...
function checkManifest(
  ...
  if (owner.packageName === '@nomix-ai/nomix-invariants') return
  if (manifest.peerDependencies?.['@nomix-ai/nomix-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@nomix-ai/nomix-invariants must be a workspace:^ peerDependency',
    )
  }
  if (manifest.devDependencies?.['@nomix-ai/nomix-invariants'] !== 'workspace:^') {
    addViolation(
      violations,
      owner.manifestPath,
      '@nomix-ai/nomix-invariants must also be a workspace:^ devDependency',
    )
  }
}
...
function checkBuild(
  ...
  if (owner.packageName !== '@nomix-ai/nomix-invariants'
