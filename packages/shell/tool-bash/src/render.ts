 ...
 *
 * @module @nomix-ai/nomix-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@nomix-ai/nomix-shell'
 ...
 * rendering story, owned by `@nomix-ai/nomix-shell` so `nomix-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@nomix-ai/nomix-shell'
