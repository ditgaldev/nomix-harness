/**
 * Package-owned invariant companion for `@nomix-ai/nomix-pwsh-sandbox`.
 * @module @nomix-ai/nomix-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-pwsh-sandbox'
