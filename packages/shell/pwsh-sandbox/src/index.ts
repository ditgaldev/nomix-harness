 ...
 * `@nomix-ai/nomix-bash-sandbox`. It wraps the exact local pwsh argv through
 ...
 * renders.
 * @module @nomix-ai/nomix-pwsh-sandbox
 */

import { Context } from '@nomix-ai/cordis'
import type { ShellExecRequest, ShellExecSpec, ShellProcess, ShellRunResult } from '@nomix-ai/nomix-shell'
import { SandboxUnavailableError } from '@nomix-ai/nomix-sandbox'
import type {
  ConfinedArgv,
  ConfinedSandboxMode,
  RunnerFailureRule,
