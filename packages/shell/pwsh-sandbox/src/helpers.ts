 ...
 * mirror of `@nomix-ai/nomix-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @nomix-ai/nomix-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@nomix-ai/nomix-shell'
import type { RunnerFailureRule } from '@nomix-ai/nomix-sandbox'
