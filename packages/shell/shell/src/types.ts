 ...
 * to `@nomix-ai/nomix-jobs`; this seam exposes only process handles. The
 ...
 * root.
 * @module nomix-shell/types
 */

import type { SandboxEnforcement, SandboxExecutionPolicy, SandboxMode } from '@nomix-ai/nomix-sandbox'
import type { CollectedOutput, NomixEnvironment } from '@nomix-ai/nomix-subprocess'

export { NOMIX_ENV_PREFIX } from '@nomix-ai/nomix-subprocess'
export type { CollectedOutput, NomixEnvironment, NomixEnvironmentKey } from '@nomix-ai/nomix-subprocess'
