/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tool-pwsh-persistent`.
 * @module @nomix-ai/nomix-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tool-pwsh-persistent'
