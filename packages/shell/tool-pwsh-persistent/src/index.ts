 ...
 * @module @nomix-ai/nomix-tool-pwsh-persistent
 */
...
import type { TerminalReadResult, TerminalSendResult, TerminalSessionId } from '@nomix-ai/nomix-terminal'
...
const SHELL_PROMPT = '__NOMIX_PERSISTENT_PWSH_PROMPT__ '
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__NOMIX_PERSISTENT_PWSH_START_${nonce}__`,
    end: `__NOMIX_PERSISTENT_PWSH_END_${nonce}:`,
  }
}
