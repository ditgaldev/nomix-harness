/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tool-bash-persistent`.
 * @module @nomix-ai/nomix-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tool-bash-persistent'
