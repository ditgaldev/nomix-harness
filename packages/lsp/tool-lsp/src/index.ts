 ...
 * `nomix-tool-call-timeout-policy` to enforce. It runtime-injects only `tools`, `lsp`, and `systemPrompt` and
 * imports no provider.
 *
 * Namespace plugin (named exports, no default export).
 * @module @nomix-ai/nomix-tool-lsp
 */
...
import { LspError } from '@nomix-ai/nomix-lsp'
import type {} from '@nomix-ai/nomix-lsp'
