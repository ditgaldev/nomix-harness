 ...
 * @module @nomix-ai/nomix-agent-presets/mount
 */
...
import type { EntryTree } from '@nomix-ai/cordis-plugin-loader'
import { scopeOf, scopeParentOf, type ScopeKey } from '@nomix-ai/nomix-scope'
...
class PresetTree extends Include {
   ...
   * dependencies, so every `@nomix-ai/nomix-*` row would fail to import. The
 ...
 * invariant companion's service listener, and `nomix-invariants` is a
