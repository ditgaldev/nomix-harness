/**
 * Package-owned invariant companion for `@nomix-ai/nomix-agent-presets`.
 * @module @nomix-ai/nomix-agent-presets/invariant
 */
...
// joins, and the `agent` field `nomix-agent` merges into its context.
...
import { leakedServices, livePresetMounts } from '@nomix-ai/nomix-agent-presets'

const PACKAGE_NAME = '@nomix-ai/nomix-agent-presets'
