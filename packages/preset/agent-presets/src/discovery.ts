 ...
 * @module @nomix-ai/nomix-agent-presets/discovery
 */
...
import { expandHomePath } from '@nomix-ai/nomix-home-paths'
 ...
 *
 * This package owns the writable root the way `nomix-skill-filesystem` owns
 * `<nomixHome>/skills`. An app must assemble the SHIPPED root, whose path only
