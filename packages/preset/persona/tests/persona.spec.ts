...
import { createScope, type ScopeKey } from '@nomix-ai/nomix-scope'
import { describe, expect, it } from 'vitest'
import * as Persona from '@nomix-ai/nomix-persona'
import { PERSONA_SECTION } from '@nomix-ai/nomix-persona'
