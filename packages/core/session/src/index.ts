 ...
 *
 * @module @nomix-ai/nomix-session
 */

import { Context, Service } from '@nomix-ai/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@nomix-ai/nomix-llm'
import { scopeOf, scopeTarget } from '@nomix-ai/nomix-scope'
import type { Scoped } from '@nomix-ai/nomix-scope'
import type { Message } from '@nomix-ai/nomix-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@nomix-ai/nomix-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@nomix-ai/nomix-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@nomix-ai/nomix-session#Session',
        wireTypeSymbol: '@nomix-ai/nomix-session/types#SessionId',
