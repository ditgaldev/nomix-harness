 ...
 * @module @nomix-ai/nomix-agent-loop/runtime-context
 */

import { createUserMessage } from '@nomix-ai/nomix-llm'
import type { ContextSnapshotSection } from '@nomix-ai/nomix-llm'
import type { Session, UserMessage } from '@nomix-ai/nomix-session'
import { isReplacementSurfaceEvent } from '@nomix-ai/nomix-session'
import type { Context } from '@nomix-ai/cordis'

const SOURCE = '@nomix-ai/nomix-system-prompt'
