 ...
 *
 * The seam itself lives in `@nomix-ai/nomix-compaction`, which re-exports these
 ...
 * `nomix-commands/brand` shape.
 *
 * @module @nomix-ai/nomix-compaction/checkpoint
 */

import type { MessageSource } from '@nomix-ai/nomix-llm/message'
