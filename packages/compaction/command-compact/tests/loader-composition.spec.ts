...
import * as commandCompact from '@nomix-ai/nomix-command-compact'
...
describe('command-compact real Loader composition', () => {
  it('discovers and executes /compact through the assembled command plane', async () => {
    root = await mkdtemp(join(tmpdir(), 'nomix-command-compact-loader-'))
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@nomix-ai/nomix-command-compact', commandCompact],
    ])
