...
import * as invariant from '@nomix-ai/nomix-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@nomix-ai/nomix-command-compact', expect.any(Function))
    expect(() => {
