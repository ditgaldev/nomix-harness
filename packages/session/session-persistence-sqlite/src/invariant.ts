/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-persistence-sqlite`.
 * @module @nomix-ai/nomix-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-persistence-sqlite'
