/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-projection-cache`.
 * @module @nomix-ai/nomix-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-projection-cache'
