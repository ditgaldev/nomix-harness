/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-persistence`.
 * @module @nomix-ai/nomix-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-persistence'
