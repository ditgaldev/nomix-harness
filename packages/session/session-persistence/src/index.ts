 ...
 * @module @nomix-ai/nomix-session-persistence
 */

import { Context, Service } from '@nomix-ai/cordis'
import { SessionPreparation } from '@nomix-ai/nomix-session'
import type { SessionEvent, SessionId, SessionHeader } from '@nomix-ai/nomix-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@nomix-ai/nomix-session'
