/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-title-all-prompts-llm`.
 * @module @nomix-ai/nomix-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-title-all-prompts-llm'
