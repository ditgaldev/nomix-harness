/**
 * OpenTelemetry Service Provider for the Nomix Harness telemetry capability.
 *
 ...
 *
 * @module @nomix-ai/nomix-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@nomix-ai/schemastery'
import type { Context } from '@nomix-ai/cordis'
import type {} from '@nomix-ai/nomix-command-feedback'
import {
...
} from '@nomix-ai/nomix-session-telemetry'
import { APP_IDENTITY } from '@nomix-ai/nomix-llm'
import { getOrCreateAnonymousUserId } from '@nomix-ai/nomix-anonymous-user-id'
import {
...
// version (same pattern as nomix-llm's attribution identity).
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@nomix-ai/nomix-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@nomix-ai/nomix-session-telemetry-otel/ops', version)
