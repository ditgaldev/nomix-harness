/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-telemetry-otel`.
 * @module @nomix-ai/nomix-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-telemetry-otel'
