 ...
 * (`deriveStats` in nomix-client-ui-conversation, that fold's whole-window
 ...
 *
 * @module @nomix-ai/nomix-session-stats/projection
 */

import { z } from 'zod'
import { isTokenDelta } from '@nomix-ai/nomix-llm/message'
