/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-title-llm`.
 * @module @nomix-ai/nomix-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-title-llm'
