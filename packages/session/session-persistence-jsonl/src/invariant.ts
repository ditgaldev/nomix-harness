/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-persistence-jsonl`.
 * @module @nomix-ai/nomix-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-persistence-jsonl'
