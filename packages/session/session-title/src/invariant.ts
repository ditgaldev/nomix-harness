/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-title`.
 * @module @nomix-ai/nomix-session-title/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-title'
