...
import LlmRuntime, { createUserMessage, LlmAdapter  } from '@nomix-ai/nomix-llm'
...
import * as providerPlugin from '@nomix-ai/nomix-session-title-first-prompt-llm'
...
async function loadComposition(): Promise<Context> {
  root = await mkdtemp(join(tmpdir(), 'nomix-title-loader-'))
  ...
  const modules = new Map<string, unknown>([
    ['@nomix-ai/nomix-llm', LlmRuntime],
    ['@nomix-ai/nomix-session', SessionStore],
    ['@nomix-ai/nomix-session-title', SessionTitleService],
    ['@nomix-ai/nomix-session-title-first-prompt-llm', providerPlugin],
  ])
