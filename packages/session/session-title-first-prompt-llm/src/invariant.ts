/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-title-first-prompt-llm`.
 * @module @nomix-ai/nomix-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-title-first-prompt-llm'
