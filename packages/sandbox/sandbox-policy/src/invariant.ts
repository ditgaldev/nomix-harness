/** Package-owned session-event invariants for sandbox policy. @module @nomix-ai/nomix-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@nomix-ai/nomix-sandbox-policy'
