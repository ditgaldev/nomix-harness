 ...
 * @module @nomix-ai/nomix-sandbox-windows-acl/acl
 */
...
export function lockFilePath(api: Win32Bindings, path: string): string {
  ...
  return join(getTempPath(api), 'nomix-acl-locks', `${digest}.lock`)
}
