/**
 * Package-owned invariant companion for `@nomix-ai/nomix-sandbox-windows-acl`.
 * @module @nomix-ai/nomix-sandbox-windows-acl/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-sandbox-windows-acl'
