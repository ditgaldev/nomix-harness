 ...
 * @module @nomix-ai/nomix-sandbox-local
 */
...
} from '@nomix-ai/node-addon-landlock-run'
import { Context } from '@nomix-ai/cordis'
import z from '@nomix-ai/schemastery'
import { assertNever } from '@nomix-ai/nomix-llm'
import { SandboxProvider, SandboxUnavailableError } from '@nomix-ai/nomix-sandbox'
import type { ConfinedArgv, ConfinedSandboxMode, RunnerFailureRule, SandboxEnforcement, SandboxPolicy } from '@nomix-ai/nomix-sandbox'
import type { SessionId } from '@nomix-ai/nomix-session'
import { AclWriteGrant, assertTempRootOutsideWorkspace, tempWriteSid, workspaceWriteSid } from '@nomix-ai/nomix-sandbox-windows-acl'
...
const PLATFORM_CHAINS: Record<string, readonly SelectedRunner['runner'][]> = {
  ...
  darwin: ['seatbelt'],
  // The Windows restricted-token runner (@nomix-ai/nomix-sandbox-windows-acl):
