 ...
 *
 * @module @nomix-ai/nomix-sandbox-local/profiles
 */

import { grantArgs as landlockGrantArgs } from '@nomix-ai/node-addon-landlock-run'
 ...
 * (`@nomix-ai/nomix-fs-sandbox`) can never drift apart.
