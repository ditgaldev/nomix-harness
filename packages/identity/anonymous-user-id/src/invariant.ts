/**
 * Package-owned invariant companion for `@nomix-ai/nomix-anonymous-user-id`.
 * @module @nomix-ai/nomix-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-anonymous-user-id'
