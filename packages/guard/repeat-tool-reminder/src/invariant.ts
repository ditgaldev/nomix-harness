/**
 * Package-owned invariant companion for `@nomix-ai/nomix-repeat-tool-reminder`.
 * @module @nomix-ai/nomix-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-repeat-tool-reminder'
