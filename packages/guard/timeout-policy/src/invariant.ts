/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tool-call-timeout-policy`.
 * @module @nomix-ai/nomix-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tool-call-timeout-policy'
