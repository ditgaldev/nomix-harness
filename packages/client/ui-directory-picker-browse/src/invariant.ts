/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-directory-picker-browse`.
 * @module @nomix-ai/nomix-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-directory-picker-browse'
