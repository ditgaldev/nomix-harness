...
const SNAPSHOT = {
  entries: [
    { entryId: '8a1b2c3d', moduleName: '@nomix-ai/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
    ...
    { entryId: 'disabled-entry', moduleName: '@nomix-ai/nomix-host-directory-picker-native', enabled: false, fiberPhase: null },
  ],
