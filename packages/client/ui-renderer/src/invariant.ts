/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-renderer`.
 * @module @nomix-ai/nomix-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-renderer'
