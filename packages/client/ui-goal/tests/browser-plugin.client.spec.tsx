...
import { ConversationEventRegistry } from '@nomix-ai/nomix-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@nomix-ai/nomix-goal/client'
