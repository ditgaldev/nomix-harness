...
import { ConversationNodeAssembler } from '@nomix-ai/nomix-client-runtime/client'
...
import { commandDefinition } from '@nomix-ai/nomix-client-ui-conversation/src/client/conversation-nodes/command.ts'
import { chatViewDefinition } from '@nomix-ai/nomix-client-ui-conversation/src/client/conversation-nodes/chat-snapshot-builder.ts'
