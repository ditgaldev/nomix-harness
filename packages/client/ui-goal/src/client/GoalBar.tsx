...
import type { GoalSnapshot } from '@nomix-ai/nomix-goal/client'
import {
...
export type GoalDockProps = import('@nomix-ai/nomix-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
