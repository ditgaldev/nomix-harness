/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-goal`.
 * @module @nomix-ai/nomix-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-goal'
