...
import { isAppendSurfaceEvent } from '@nomix-ai/nomix-client-runtime/client'
import type { MarkdownFileMentions } from '@nomix-ai/nomix-client-ui-primitives'
import type { TurnTailOwnerProps } from '@nomix-ai/nomix-client-ui-conversation/client'
...
declare module '@nomix-ai/nomix-client-runtime/client' {
