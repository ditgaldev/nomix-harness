/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-deliverables`.
 * @module @nomix-ai/nomix-client-ui-deliverables/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-deliverables'
