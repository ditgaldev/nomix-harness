...
import type { ChatFileMentions, TurnTailOwnerProps } from '@nomix-ai/nomix-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@nomix-ai/nomix-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@nomix-ai/nomix-client-ui-deliverables'])
