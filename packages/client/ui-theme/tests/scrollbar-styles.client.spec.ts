...
const INDIRECTION_PREFIX = '--nomix-scrollbar-'
...
const ELEVATED_REBIND = new Map([
  ['--nomix-scrollbar-thumb', '--dsw-alias-scrollbar-bg-l2'],
  ['--nomix-scrollbar-thumb-hover', '--dsw-alias-scrollbar-hover-l2'],
...
describe('scrollbar.css width variable', () => {
  ...
  it('every reader of the width variable outside ui-theme references a defined variable', () => {
    ...
    // (`right: var(--nomix-scrollbar-width)`); a rename in scrollbar.css without
