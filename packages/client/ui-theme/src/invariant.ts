/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-theme`.
 * @module @nomix-ai/nomix-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-theme'
