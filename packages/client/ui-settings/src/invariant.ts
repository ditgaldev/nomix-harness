/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-settings`.
 * @module @nomix-ai/nomix-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-settings'
