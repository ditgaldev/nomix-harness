 ...
 * @module @nomix-ai/nomix-client-ui-message-feedback/client/controller
 */

import type { RemoteResult } from '@nomix-ai/nomix-typert-protocol'
import type { HostObservable } from '@nomix-ai/nomix-client-ui-slots'
import type { MessageId, SessionId } from '@nomix-ai/nomix-client-connection/client'
import type {
...
} from '@nomix-ai/nomix-message-feedback/types'
