 ...
 * @module @nomix-ai/nomix-client-ui-message-feedback/client/slots
 */
...
import type { MessageId } from '@nomix-ai/nomix-client-connection/client'
import type { MessageFeedbackRating } from '@nomix-ai/nomix-message-feedback/types'
