/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-message-feedback`.
 * @module @nomix-ai/nomix-client-ui-message-feedback/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-message-feedback'
