/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-web-react`.
 * @module @nomix-ai/nomix-client-web-react/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-web-react'
