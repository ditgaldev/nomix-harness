...
import { SlotCore, type PropsRenderSlots, type SlotRendererHost } from '@nomix-ai/nomix-client-ui-slots'
import { createSlotRenderer, StaleAuthorizationError } from '@nomix-ai/nomix-client-web-react'
