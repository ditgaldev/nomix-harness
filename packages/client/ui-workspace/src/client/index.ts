 ...
 */
import type { ConnectionHandle } from '@nomix-ai/nomix-client-connection/client'
import type { HostObservable } from '@nomix-ai/nomix-client-ui-slots'
 ...
 * to this one is NOT constrained: nomix.client.inject edges are informational
