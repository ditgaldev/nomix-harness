...
import { apply, inject } from '@nomix-ai/nomix-client-ui-workspace/client'
import type { WorkspaceBrowserInjected, WorkspacePickerInjected } from '@nomix-ai/nomix-client-ui-workspace/client'
