 ...
 * ordering and labels.
 *
 * @module @nomix-ai/nomix-client-ui-reference/client
 */
...
} from '@nomix-ai/nomix-client-ui-input-trigger/client'
import { formatFileMention } from '@nomix-ai/nomix-file-reference/grammar'
import type { FileReferenceCandidate } from '@nomix-ai/nomix-file-reference/types'
import type { SessionReferenceMentionCandidate } from '@nomix-ai/nomix-session-reference/types'
