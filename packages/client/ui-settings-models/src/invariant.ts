/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-settings-models`.
 * @module @nomix-ai/nomix-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-settings-models'
