...
import { SettingsDescribeMirror } from '@nomix-ai/nomix-client-ui-settings/src/client/settings-mirror.ts'
import { SettingsScopeController } from '@nomix-ai/nomix-client-ui-settings/src/client/settings-scope.ts'
