/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-runtime`.
 * @module @nomix-ai/nomix-client-runtime/invariant
 */
...
import type { SlotMap } from '@nomix-ai/nomix-client-ui-slots'
import type { InvariantInstaller } from '@nomix-ai/nomix-invariants'

const PACKAGE_NAME = '@nomix-ai/nomix-client-runtime'
