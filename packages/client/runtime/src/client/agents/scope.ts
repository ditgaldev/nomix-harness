 ...
 * Agent's identity. The mechanism mirrors the host `nomix-scope` architecture
...
import type { SessionId } from '@nomix-ai/nomix-api-remotes/client'
import type { TypertClientRemote, TypertRemoteScopeApi } from '@nomix-ai/nomix-typert-protocol'
...
const kScope = Symbol('nomix.client.scope')
