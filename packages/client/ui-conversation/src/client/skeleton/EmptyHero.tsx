...
import {
  IconChevronDownOutline14, IconFolderClose16, IconFolderOpen16, NomixLogo,
} from '@nomix-ai/nomix-client-ui-primitives'
import { workspaceTitleOf } from '@nomix-ai/nomix-client-runtime/client'
        ...
        <div className={css.headline}>
          ...
          <span className={css.fishHitbox}>
            {renderSlot('conversation.hero.brand.mark', { size: 34, className: css.fish }, {
              fallback: <NomixLogo size={34} className={css.fish} />,
            })}
          </span>
