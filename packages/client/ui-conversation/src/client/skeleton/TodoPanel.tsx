...
import type { TodoItem } from '@nomix-ai/nomix-tool-todo/client'
import { IconChecklistOutline14, IconChevronDownOutline14, IconChevronUpOutline14 } from '@nomix-ai/nomix-client-ui-primitives'
...
/** Local exhaustiveness helper — client packages do not depend on `nomix-llm`. */
