...
import { AttachmentRail, DropOverlay, ImageLightbox } from '@nomix-ai/nomix-client-ui-attachment'
import type { AttachmentRailItem } from '@nomix-ai/nomix-client-ui-attachment'
// Type-only: the `plan` projection key merge (the TodoDock posture — the
// composer reads a host-computed value; the domain owns the key).
import type {} from '@nomix-ai/nomix-plan-mode/client'
// Type-only: the `goal` projection key merge (hint disambiguation).
import type {} from '@nomix-ai/nomix-goal/client'
...
import type { Translate } from '@nomix-ai/nomix-client-ui-slots'
