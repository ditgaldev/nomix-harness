...
import type { ContextMessageNode } from '@nomix-ai/nomix-client-runtime/client'
import type { ChatViewSlotProps } from '../contract/slots.ts'
import { DisclosureRow, IconBrowseOutline16 } from '@nomix-ai/nomix-client-ui-primitives'
