/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-conversation`.
 * @module @nomix-ai/nomix-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-conversation'
