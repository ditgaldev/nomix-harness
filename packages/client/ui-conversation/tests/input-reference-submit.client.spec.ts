...
import type { InputTriggerController, SubmitOutcome } from '@nomix-ai/nomix-client-ui-input-trigger/client'
import { SessionInputShell } from '../src/client/input/facade.ts'
import type { DraftAttachmentId } from '../src/client/input/contract.ts'

const mention = '@[Research](nomix-session:InNvdXJjZSI)'
const spacedMention = '@[Research notes](nomix-session:InNvdXJjZSI)'
const commandImages = {
