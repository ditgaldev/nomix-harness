...
import type { ClientSessionContext, CommandClaim, PickOutcome, SubmitOutcome } from '@nomix-ai/nomix-client-ui-input-trigger/client'
...
import type { ConversationSnapshot } from '@nomix-ai/nomix-client-runtime/client'
