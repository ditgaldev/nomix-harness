/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-schema-form`.
 * @module @nomix-ai/nomix-client-schema-form/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-schema-form'
