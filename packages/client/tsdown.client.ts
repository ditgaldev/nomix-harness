 ...
 */
export const INLINE_SAFE = /^@nomix-ai\/nomix-(host-apiproxy|session|llm|tools|brand)(\/|$)/
 ...
 */
const RUNTIME_STORE_EXEMPTION = '@nomix-ai/nomix-client-runtime/client'
...
function clientConfig(id: string, entry: string): UserConfig {
  return {
    ...
    plugins: [{
      ...
      // and every other @nomix-ai value import is a build error — a
