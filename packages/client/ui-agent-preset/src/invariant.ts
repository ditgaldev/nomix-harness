/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-agent-preset`.
 * @module @nomix-ai/nomix-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-agent-preset'
