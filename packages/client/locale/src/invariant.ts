/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-locale`.
 * @module @nomix-ai/nomix-client-locale/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-locale'
