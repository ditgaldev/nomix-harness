...
import type { ClientContext, SettingsScope } from '@nomix-ai/nomix-client-runtime/client'
...
export type { Translate, TranslateNS } from '@nomix-ai/nomix-client-ui-slots'
...
export class LocaleRuntime {
   ...
   * different browser sharing the same NOMIX home. Only the render notification
