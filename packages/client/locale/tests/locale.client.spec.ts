...
import { stubSettingsScope, type StubSettingsScope } from '@nomix-ai/nomix-client-test-runtime'
import type { LocaleSettings, LocaleSnapshot } from '@nomix-ai/nomix-client-locale/client'
import { FALLBACK_LOCALE, LocaleRuntime } from '@nomix-ai/nomix-client-locale/client'
 ...
 * `usePinnedBrowserLanguages` (nomix-client-test-runtime): they need the shapes
...
describe('LocaleRuntime', () => {
  ...
  it('persists an explicit pick of the provisional locale, so a shared NOMIX home agrees', () => {
