...
import { apply as nodeApply } from '@nomix-ai/nomix-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@nomix-ai/nomix-client-locale/client'
import * as LocaleInvariant from '@nomix-ai/nomix-client-locale/invariant'
