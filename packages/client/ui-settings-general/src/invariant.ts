/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-settings-general`.
 * @module @nomix-ai/nomix-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-settings-general'
