/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-connection`.
 * @module @nomix-ai/nomix-client-connection/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-connection'
