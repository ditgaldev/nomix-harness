...
import type { ComposerChainProps } from '@nomix-ai/nomix-client-ui-conversation/client'
import { InputTriggerService } from '@nomix-ai/nomix-client-ui-input-trigger/client'
import type { ClientSessionContext, InputTriggerSource } from '@nomix-ai/nomix-client-ui-input-trigger/client'
import { apply as applyLocale, inject as localeInject } from '@nomix-ai/nomix-client-locale/client'
import {
