/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-subagent`.
 * @module @nomix-ai/nomix-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-subagent'
