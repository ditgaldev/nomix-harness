...
import {
  IconNewChatOutline16, IconPanelLeftOutline16, NomixLogo, Tooltip,
} from '@nomix-ai/nomix-client-ui-primitives'
  ...
  return (
    ...
    >
      <div className={css.logoRow}>
          ...
          >
            <span className={css.brandIdentity} aria-hidden="true">
              <span className={css.brandMark}>
                {renderSlot('sidebar.brand.mark', { size: 24 }, { fallback: <NomixLogo size={24} /> })}
              </span>
              <span className={css.brandName}>
                {renderSlot('sidebar.brand.name', {}, {
                  fallback: (
                    <>
                      <span className={css.fallbackBrandName}>NOMIX Local Build</span>
                      {process.env.NOMIX_CLIENT_COMMIT_HASH
                        ? <span className={css.buildRevision}>{process.env.NOMIX_CLIENT_COMMIT_HASH}</span>
                        : null}
                    </>
                  ),
                })}
        ...
        {/* Rail resting state is the Nomix mark; hovering swaps in the panel
