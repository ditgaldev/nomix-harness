 ...
 */
import type { PropsLocale, PropsRenderSlots, PropsRuntime } from '@nomix-ai/nomix-client-ui-slots'
// Type-only: pulls ui-layout's SlotMap merge (the 'sidebar' entry) into every
// program that sees this contract, so PropsRuntime<'sidebar'> resolves.
import type {} from '@nomix-ai/nomix-client-ui-layout/client'
import type { WorkspaceId } from '@nomix-ai/nomix-client-runtime/client'
