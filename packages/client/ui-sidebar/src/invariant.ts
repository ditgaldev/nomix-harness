/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-sidebar`.
 * @module @nomix-ai/nomix-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-sidebar'
