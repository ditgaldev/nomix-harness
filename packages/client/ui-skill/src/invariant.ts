/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-skill`.
 * @module @nomix-ai/nomix-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-skill'
