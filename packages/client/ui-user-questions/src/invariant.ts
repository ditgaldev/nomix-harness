/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-user-questions`.
 * @module @nomix-ai/nomix-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-user-questions'
