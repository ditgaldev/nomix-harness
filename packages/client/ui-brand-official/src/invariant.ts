/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-brand-official`.
 * @module @nomix-ai/nomix-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-brand-official'
