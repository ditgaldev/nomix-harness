/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-permission-presets`.
 * @module @nomix-ai/nomix-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-permission-presets'
