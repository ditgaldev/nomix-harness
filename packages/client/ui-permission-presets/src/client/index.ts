 ...
 */
import type { ConnectionHandle } from '@nomix-ai/nomix-api-remotes/client'
...
import type {} from '@nomix-ai/nomix-client-ui-settings/client'
// Type-only: pulls the ctx.remote merge and the forwarded-event key face
// (the settings invalidation rides the allowlist) into this program.
import type {} from '@nomix-ai/nomix-api-remotes/client'
import type { ClientContext, SessionFace } from '@nomix-ai/nomix-client-runtime/client'
import type { CommandUiContract, SelectOption } from '@nomix-ai/nomix-client-ui-commands/client'
import type { ClientSessionContext } from '@nomix-ai/nomix-client-ui-input-trigger/client'
