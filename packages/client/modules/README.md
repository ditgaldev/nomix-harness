...
- **No unload bookkeeping of its own** — style removal and fiber teardown ordering live with the HMR driver (`@nomix-ai/nomix-client-hmr`); the loader only inventories owned style tag ids per record.
