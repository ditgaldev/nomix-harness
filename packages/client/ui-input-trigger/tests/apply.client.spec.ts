...
import { usePinnedBrowserLanguages } from '@nomix-ai/nomix-client-test-runtime'
import { createScope, scopeOf, SlotRegistry } from '@nomix-ai/nomix-client-runtime/client'
import type { SessionId } from '@nomix-ai/nomix-client-runtime/client'
import { apply, inject, InputTriggerService } from '@nomix-ai/nomix-client-ui-input-trigger/client'
import type { MenuViewInjected } from '@nomix-ai/nomix-client-ui-input-trigger/client'
