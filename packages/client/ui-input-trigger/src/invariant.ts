/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-input-trigger`.
 * @module @nomix-ai/nomix-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-input-trigger'
