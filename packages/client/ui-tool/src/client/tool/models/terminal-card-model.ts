 ...
 * @module
 */
import { resolveWorkspacePath } from '@nomix-ai/nomix-client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@nomix-ai/nomix-client-ui-primitives'
