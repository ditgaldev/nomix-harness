 ...
 * ({@link module:@nomix-ai/nomix-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@nomix-ai/nomix-client-ui-primitives'
