/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-tool`.
 * @module @nomix-ai/nomix-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-tool'
