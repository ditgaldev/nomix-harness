...
import type { HostDescription } from '@nomix-ai/nomix-client-connection/client'
import type {
...
import type { SessionProviderComponent, TranslateNS } from '@nomix-ai/nomix-client-ui-slots'
import type { DetailsSlotProps, DetailsToolOwnerProps } from '@nomix-ai/nomix-client-ui-conversation/src/client/contract/slots.ts'
