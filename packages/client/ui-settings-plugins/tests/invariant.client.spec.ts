...
import * as PluginConfigInvariant from '@nomix-ai/nomix-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@nomix-ai/nomix-client-ui-settings-plugins')
