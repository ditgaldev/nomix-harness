/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-settings-plugins`.
 * @module @nomix-ai/nomix-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-settings-plugins'
