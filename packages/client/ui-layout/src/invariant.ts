/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-layout`.
 * @module @nomix-ai/nomix-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-layout'
