...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@nomix-ai/nomix-client-ui-theme/client'
import { apply, inject, LayoutController } from '@nomix-ai/nomix-client-ui-layout/client'
import { apply as nodeApply } from '@nomix-ai/nomix-client-ui-layout'
import * as invariant from '@nomix-ai/nomix-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@nomix-ai/nomix-client-ui-layout', expect.any(Function))
