/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-trajectory`.
 * @module @nomix-ai/nomix-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-trajectory'
