...
import { resolveSlotLabel } from '@nomix-ai/nomix-client-ui-slots'
import {
  ConversationEventRegistry, ConversationViewRegistry, createSnapshotStore,
  EMPTY_CHAT_SNAPSHOT,
} from '@nomix-ai/nomix-client-runtime/client'
import { SlotRegistry } from '@nomix-ai/nomix-client-runtime/client'
import type {
  ConversationSnapshot, RequestView,
  SessionId, SessionListState, SnapshotStore, WorkspaceListState,
} from '@nomix-ai/nomix-client-runtime/client'
import type { ConvViewProps, ViewTab } from '@nomix-ai/nomix-client-ui-conversation/client'
import {
  ConversationSession, ConversationSessionHeader,
  type ConversationSessionHeaderProps, type ConversationSessionProps,
} from '@nomix-ai/nomix-client-ui-conversation/src/client/skeleton/ConversationSession.tsx'
import { createChatStore } from '@nomix-ai/nomix-client-ui-conversation/src/client/stores.ts'
import { zh as conversationZh } from '@nomix-ai/nomix-client-ui-conversation/src/client/locales.ts'
import { apply as localeApply, inject as localeInject } from '@nomix-ai/nomix-client-locale/client'
import { stubSettingsScope } from '@nomix-ai/nomix-client-test-runtime'
import type { LocaleKeysOf } from '@nomix-ai/nomix-client-ui-slots'
import { zh, type TrajectoryKey } from '../src/client/locales.ts'
import { apply, inject } from '@nomix-ai/nomix-client-ui-trajectory/client'
import { apply as nodeApply } from '@nomix-ai/nomix-client-ui-trajectory'
...
describe('plugin registration', () => {
  ...
  it('shares one browser-wide duration preference across session injections', async () => {
    ...
    expect(localStorage.getItem('nomix.trajectory.duration')).toBe('true')
    expect(localStorage.getItem(`nomix.trajectory.duration.${SID}`)).toBeNull()
  })
