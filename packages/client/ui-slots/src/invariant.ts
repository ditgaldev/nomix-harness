/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-slots`.
 * @module @nomix-ai/nomix-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-slots'
