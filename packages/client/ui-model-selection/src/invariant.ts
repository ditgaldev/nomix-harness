/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-model-selection`.
 * @module @nomix-ai/nomix-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-model-selection'
