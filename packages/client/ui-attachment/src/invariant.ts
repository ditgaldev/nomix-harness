/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-attachment`.
 * @module @nomix-ai/nomix-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-attachment'
