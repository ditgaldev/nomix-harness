...
import type { WebBootGraph, ClientModuleRegistry } from '@nomix-ai/nomix-client-modules'
import type { WebRoute, WebServer } from '@nomix-ai/nomix-host-webserver'
...
beforeEach(() => { dir = mkdtempSync(join(tmpdir(), 'nomix-hmr-')) })
