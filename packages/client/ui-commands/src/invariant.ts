/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-commands`.
 * @module @nomix-ai/nomix-client-ui-commands/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-commands'
