...
import Storage, { storageBackendServiceKey } from '@nomix-ai/nomix-storage'
import type { KvUnitDescriptor } from '@nomix-ai/nomix-storage'
...
async function freshDbPath(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'nomix-storage-sqlite-'))
  dirs.push(dir)
