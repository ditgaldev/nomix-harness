/**
 * Package-owned invariant companion for `@nomix-ai/nomix-storage-sqlite`.
 * @module @nomix-ai/nomix-storage-sqlite/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-storage-sqlite'
