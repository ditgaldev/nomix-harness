/**
 * Package-owned invariant companion for `@nomix-ai/nomix-storage-domain`: every
 ...
 * @module @nomix-ai/nomix-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-storage-domain'
