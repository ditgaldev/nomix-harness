/**
 * Package-owned invariant companion for `@nomix-ai/nomix-storage-json`.
 * @module @nomix-ai/nomix-storage-json/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-storage-json'
