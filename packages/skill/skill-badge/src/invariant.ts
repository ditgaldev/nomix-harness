/**
 * Package-owned invariant companion for `@nomix-ai/nomix-skill-badge`.
 * @module @nomix-ai/nomix-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-skill-badge'
