 ...
 * Concrete
 * providers such as `@nomix-ai/nomix-skill-filesystem` decide where skills come
 ...
 *
 * @module @nomix-ai/nomix-skill
 */

import { Context, Service } from '@nomix-ai/cordis'
import { assertNever } from '@nomix-ai/nomix-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@nomix-ai/nomix-scope'
...
export type SkillSource = 'project-nomix' | 'project-agents' | 'runtime' | 'user-nomix' | 'user-agents' | 'custom' | 'bundled' | (string & {})
