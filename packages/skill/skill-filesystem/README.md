...
| `dshHome` | `$DSH_HOME` or `~/.dsh` | DeepSeek Harness config root resolved by [`@nomix-ai/nomix-home-paths`](../../util/home-paths/README.md); scans `skills` under this directory. |
