/** Package-owned permission-preset event invariants. @module @nomix-ai/nomix-permission-presets/invariant */
...
const PACKAGE_NAME = '@nomix-ai/nomix-permission-presets'
