/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tool-ask-user`.
 * @module @nomix-ai/nomix-tool-ask-user/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tool-ask-user'
