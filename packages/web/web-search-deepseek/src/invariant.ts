/**
 * Package-owned invariant companion for `@nomix-ai/nomix-web-search-deepseek`.
 * @module @nomix-ai/nomix-web-search-deepseek/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-web-search-deepseek'
