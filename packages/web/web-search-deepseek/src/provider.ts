 ...
 * @module @nomix-ai/nomix-web-search-deepseek/provider
 */

import { WebError } from '@nomix-ai/nomix-web'
import type {
  WebSearchProvider,
  WebSearchRequest,
  WebSearchResult,
  WebSearchSource,
} from '@nomix-ai/nomix-web'
import type { CredentialRef } from '@nomix-ai/nomix-credentials'
import type {} from '@nomix-ai/nomix-session'
import type {
  AnthropicError,
  AnthropicResponse,
  ContentBlock,
 ...
 * (`https://api.deepseek.com`) `@nomix-ai/nomix-llm-deepseek` uses, so this
