...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@nomix-ai/nomix-tools'
import type { WebFetchBody, WebFetchResult } from '@nomix-ai/nomix-web'
 ...
 * `@nomix-ai/nomix-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@nomix-ai/nomix-tool-call-timeout-policy` to enforce.
