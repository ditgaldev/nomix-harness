/**
 * Package-owned invariant companion for `@nomix-ai/nomix-launch-environment`.
 * @module @nomix-ai/nomix-launch-environment/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-launch-environment'
