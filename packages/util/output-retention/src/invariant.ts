/**
 * Package-owned invariant companion for `@nomix-ai/nomix-output-retention`.
 * @module @nomix-ai/nomix-output-retention/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-output-retention'
