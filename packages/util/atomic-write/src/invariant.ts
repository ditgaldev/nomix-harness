/**
 * Package-owned invariant companion for `@nomix-ai/nomix-atomic-write`.
 * @module @nomix-ai/nomix-atomic-write/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-atomic-write'
