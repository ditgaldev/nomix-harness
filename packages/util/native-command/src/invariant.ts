/**
 * Package-owned invariant companion for `@nomix-ai/nomix-native-command`.
 * @module @nomix-ai/nomix-native-command/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-native-command'
