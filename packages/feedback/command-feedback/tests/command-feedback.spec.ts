...
import SessionStore, { foldSurface, Session, SessionId } from '@nomix-ai/nomix-session'
import { SessionTelemetryBackend, type SessionTelemetrySharingStatus } from '@nomix-ai/nomix-session-telemetry'
...
vi.mock('@nomix-ai/nomix-anonymous-user-id', () => ({
...
describe('@nomix-ai/nomix-command-feedback registration', () => {
