/**
 * Package-owned invariant companion for `@nomix-ai/nomix-subagent-nomix-sdk`.
 * @module @nomix-ai/nomix-subagent-nomix-sdk/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-subagent-nomix-sdk'

/** Cordis companion plugin name. */
export const name = 'subagent-nomix-sdk-invariant'
