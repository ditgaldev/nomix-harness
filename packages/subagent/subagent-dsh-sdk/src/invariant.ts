/**
 * Package-owned invariant companion for `@nomix-ai/nomix-subagent-dsh-sdk`.
 * @module @nomix-ai/nomix-subagent-dsh-sdk/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-subagent-dsh-sdk'
