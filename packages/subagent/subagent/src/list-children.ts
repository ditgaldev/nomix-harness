...
import type { Session, SessionEvent, SessionHeader, SessionId } from '@nomix-ai/nomix-session'
import type { SessionPersistence } from '@nomix-ai/nomix-session-persistence'
import type { SessionProjectionRegistry } from '@nomix-ai/nomix-session-projection'
import type { SessionProjectionCache } from '@nomix-ai/nomix-session-projection-cache'
...
async function prepareListing(
  ...
  if (projections === undefined) {
    throw new SubagentError(
      'listing subagents requires the sessionProjections registry (load @nomix-ai/nomix-session-projection)',
  ...
  if (sessions === undefined) {
    throw new SubagentError(
      'listing subagents requires the session store (load @nomix-ai/nomix-session)',
