...
import SandboxPolicyService, { effectiveSandboxMode, setSandboxMode } from '@nomix-ai/nomix-sandbox-policy'
...
import ApprovalService, { effectiveApprovalPolicy } from '@nomix-ai/nomix-user-approval'
...
async function setup(script: Script) {
  ...
  const root = mkdtempSync(join(tmpdir(), 'nomix-continuation-inherit-'))
  roots.push(root)
