/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tool-subagent`.
 * @module @nomix-ai/nomix-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tool-subagent'
