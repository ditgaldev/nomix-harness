 ...
 *
 * @module @nomix-ai/nomix-subagent-codex/wire
 */

import type { Readable, Writable } from 'node:stream'
import type { ContentBlock } from '@nomix-ai/nomix-llm'
import type { SubagentResult } from '@nomix-ai/nomix-subagent'
import { JsonRpcLineTransport } from '@nomix-ai/nomix-sdk-protocol'
