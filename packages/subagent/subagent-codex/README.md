...
- **No human approval path** — known unattended approval requests are denied and unknown server requests fail closed; the three Profile modes never create a NOMIX interaction channel or per-call allow policy.
