...
import { Context, symbols, type EffectMeta } from '@nomix-ai/cordis'
...
import SubagentRuntime, { type SubagentStartRequest } from '@nomix-ai/nomix-subagent'
import { MockAdapter, maxTokensResponse, textResponse, toolCallResponse } from '../../../core/agent-loop/tests/mock-adapter.ts'
import * as spawn from '../src/index.ts'
import { STRUCTURED_OUTPUT_TOOL } from '@nomix-ai/nomix-subagent-in-process-driver'
...
describe('nomix-subagent-spawn-in-process', () => {
