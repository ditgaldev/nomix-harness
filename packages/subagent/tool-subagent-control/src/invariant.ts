/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tool-subagent-control`.
 * @module @nomix-ai/nomix-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tool-subagent-control'
