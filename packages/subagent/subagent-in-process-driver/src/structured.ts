 ...
 * @module @nomix-ai/nomix-subagent-in-process-driver/structured
 */

import type { Context } from '@nomix-ai/cordis'
import type { ToolSchema } from '@nomix-ai/nomix-llm'
import type { ToolExecution, ToolRunContext } from '@nomix-ai/nomix-tools'
import { ToolArgsError, validateJsonSchemaValue, type ObjectJsonSchema } from '@nomix-ai/nomix-tools'
 ...
 *   `assertObjectJsonSchema` in nomix-tools).
