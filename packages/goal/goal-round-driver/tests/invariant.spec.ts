...
import * as GoalSessionInvariant from '@nomix-ai/nomix-goal-round-driver/invariant'
import { renderGoalRoundPrompt } from '@nomix-ai/nomix-goal-round-driver'
import InvariantRegistry, { InvariantError } from '@nomix-ai/nomix-invariants'
import SessionStore, { SessionId, type Session } from '@nomix-ai/nomix-session'
...
describe('goal-round-driver prompt invariants', () => {
  ...
  it('rejects a continuation whose content differs from the package renderer', async () => {
    ...
    expect(() => {
      ...
      code: 'INVARIANT',
      packageName: '@nomix-ai/nomix-goal-round-driver',
    }))
  })
