/** Package-owned goal-round prompt invariants. @module @nomix-ai/nomix-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@nomix-ai/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@nomix-ai/nomix-goal'
...
const PACKAGE_NAME = '@nomix-ai/nomix-goal-round-driver'
