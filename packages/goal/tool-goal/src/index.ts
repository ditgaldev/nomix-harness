 ...
 * @module @nomix-ai/nomix-tool-goal
 */

import type { Context } from '@nomix-ai/cordis'
import z from '@nomix-ai/schemastery'
import { GoalId } from '@nomix-ai/nomix-goal'
import type { GoalRef, GoalView } from '@nomix-ai/nomix-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@nomix-ai/nomix-llm'
import { defineTool } from '@nomix-ai/nomix-tools'
import type { GenericCallView } from '@nomix-ai/nomix-tools'
