/**
 * Package-owned invariant companion for `@nomix-ai/nomix-command-goal`.
 * @module @nomix-ai/nomix-command-goal/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-command-goal'
