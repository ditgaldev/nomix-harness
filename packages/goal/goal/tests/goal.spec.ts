...
import { createUserMessage, HarnessError } from '@nomix-ai/nomix-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@nomix-ai/nomix-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
  foldGoal,
} from '@nomix-ai/nomix-goal'
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@nomix-ai/nomix-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@nomix-ai/nomix-session').SessionEvent[]): StubAgent {
