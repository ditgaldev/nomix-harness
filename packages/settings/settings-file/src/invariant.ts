/**
 * Package-owned invariant companion for `@nomix-ai/nomix-settings-file`.
 * @module @nomix-ai/nomix-settings-file/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@nomix-ai/nomix-settings`.
 */
