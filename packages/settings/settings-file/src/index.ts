 ...
 * leaf-level diff.
 * @module @nomix-ai/nomix-settings-file
 */
...
import { SettingsProvider, deepEqualJson, type SettingsNamespace } from '@nomix-ai/nomix-settings'
...
export function resolveSpec(config: Config): ResolvedSpec {
  const filename = resolve(config.path ?? join(resolveNomixHome(config.nomixHome), 'settings.yaml'))
