 ...
 *
 * @module nomix-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from '@nomix-ai/nomix-llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryRequest } from '@nomix-ai/nomix-llm'
import { attributionHeaders } from '@nomix-ai/nomix-llm'
 ...
 * on the length the server claims — the same two-stage shape `nomix-web-fetch`
