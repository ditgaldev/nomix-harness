...
import type { AuthorizationMethod, AuthorizationPrompt, AuthorizationSession } from '@nomix-ai/nomix-authorization'
import { isCredentialKeySegment } from '@nomix-ai/nomix-credentials'
