...
import { AttachmentId, AttachmentStore, ImageVariantId } from '@nomix-ai/nomix-attachment'
import type {
...
import LlmRuntime, { createUserMessage, CallId } from '@nomix-ai/nomix-llm'
import type { Message, ToolSchema } from '@nomix-ai/nomix-llm'
import * as LlmPiAi from '@nomix-ai/nomix-llm-pi-ai'
...
const openAIBaseURL = process.env.NOMIX_PI_AI_OPENAI_BASE_URL
...
const anthropicBaseURL = process.env.NOMIX_PI_AI_ANTHROPIC_BASE_URL

const providerCases: ProviderCase[] = [
  {
    provider: 'openai',
    api: 'openai-responses',
    model: process.env.NOMIX_PI_AI_OPENAI_MODEL ?? 'gpt-5.5',
    ...azureOpenAIKey
  ...
  },
  {
    ...
    model: process.env.NOMIX_PI_AI_ANTHROPIC_MODEL ?? 'claude-opus-4-8',
