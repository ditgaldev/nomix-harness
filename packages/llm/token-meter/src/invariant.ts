/**
 * Package-owned invariant companion for `@nomix-ai/nomix-token-meter`.
 * @module @nomix-ai/nomix-token-meter/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-token-meter'
