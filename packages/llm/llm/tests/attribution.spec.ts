...
import { APP_IDENTITY, attributionHeaders, userAgent } from '@nomix-ai/nomix-llm'
import type { AppIdentity } from '@nomix-ai/nomix-llm'
...
describe('userAgent', () => {
  it('renders product/version with the +url comment', () => {
    expect(userAgent()).toBe(
      `nomix-harness/${manifest.version} (+https://github.com/ditgaldev/nomix-harness)`,
    )
  })
