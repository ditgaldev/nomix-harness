 ...
 *
 * @module nomix-llm-deepseek/adapter
 */

import { attributionHeaders, contentHasImage, CONTEXT_WINDOW_EXCEEDED_CODE, isContextWindowExceededError, isQuotaExceededError, LlmAdapter, LlmError, offloadRequestImagesWithPolicy, ProviderRequestId, QUOTA_EXCEEDED_CODE, ReasoningEffortId } from '@nomix-ai/nomix-llm'
import type {
  ContentBlock,
  GenerateOptions,
  LlmModelInfo,
...
} from '@nomix-ai/nomix-attachment'
import type { CredentialRef } from '@nomix-ai/nomix-credentials'
import { deadline, idleWatchdog, timeoutOf } from '@nomix-ai/nomix-timeout'
import type { AnonymousUserId } from '@nomix-ai/nomix-anonymous-user-id'
...
export class DeepSeekAdapter extends LlmAdapter {
  ...
  private async * request(
    ...
    const headers = {
      ...
      ...attributionHeaders(),
      'x-nomix-harness-user-id': String(userId),
      ...options.sessionId !== undefined
        ? { 'x-nomix-harness-session-id': String(options.sessionId) }
        : {},
      ...options.purpose === 'compaction'
        ? { 'x-nomix-harness-compact': '1' }
        : {},
    }
