...
import LlmRuntime, { createUserMessage, INVALID_CREDENTIAL_CODE } from '@nomix-ai/nomix-llm'
...
async function home(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'nomix-llm-dynamic-'))
