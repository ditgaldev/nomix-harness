/** Package-owned invariant companion for the directory-picker seam. @module @nomix-ai/nomix-host-directory-picker/invariant */

import type { Context } from '@nomix-ai/cordis'
import type { InvariantInstaller } from '@nomix-ai/nomix-invariants'

const PACKAGE_NAME = '@nomix-ai/nomix-host-directory-picker'
