...
import HttpServer from '@nomix-ai/nomix-host-webserver'
import type { DirectoryPicker } from '@nomix-ai/nomix-host-directory-picker'
import BrowseDirectoryPicker from '@nomix-ai/nomix-host-directory-picker-browse'
import NativeDirectoryPicker from '@nomix-ai/nomix-host-directory-picker-native'
...
const AUTO = '@nomix-ai/nomix-host-directory-picker-auto'
const NATIVE = '@nomix-ai/nomix-host-directory-picker-native'
const BROWSE = '@nomix-ai/nomix-host-directory-picker-browse'
const NATIVE_SURFACE = '@nomix-ai/nomix-client-ui-directory-picker-native'
const BROWSE_SURFACE = '@nomix-ai/nomix-client-ui-directory-picker-browse'
...
async function loadComposition(
  ...
  const modules = new Map<string, unknown>([
    ['@nomix-ai/nomix-host-webserver', HttpServer],
