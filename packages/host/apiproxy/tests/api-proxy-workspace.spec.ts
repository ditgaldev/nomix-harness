...
import type { Agent, AgentFactory } from '@nomix-ai/nomix-agent'
import SessionStore, { SessionId } from '@nomix-ai/nomix-session'
import type { Session } from '@nomix-ai/nomix-session'
import Storage from '@nomix-ai/nomix-storage'
import { DomainFacility } from '@nomix-ai/nomix-storage-domain'
...
import type { DirectoryPickerCapability } from '@nomix-ai/nomix-host-directory-picker'
import WorkspaceRegistry from '@nomix-ai/nomix-workspace'
import type { HostFrame, WorkspaceId } from '@nomix-ai/nomix-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@nomix-ai/nomix-host-apiproxy/api/rpc'
...
async function harness(
  root = realpathSync.native(mkdtempSync(join(tmpdir(), 'nomix-apiproxy-workspace-'))),
