...
import AgentRegistry, { type AgentFactory } from '@nomix-ai/nomix-agent'
...
import { GoalId } from '@nomix-ai/nomix-goal'
...
async function harness(
  ...
  const cwd = realpathSync(mkdtempSync(join(tmpdir(), 'nomix-apiproxy-preset-')))
