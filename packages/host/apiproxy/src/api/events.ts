...
import type { AskUserQuestionItem } from '@nomix-ai/nomix-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@nomix-ai/nomix-user-approval/types'
import type { Message } from '@nomix-ai/nomix-llm/types'
import type { MessageId } from '@nomix-ai/nomix-llm/brand'
import type { CallId } from '@nomix-ai/nomix-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@nomix-ai/nomix-session/types'
import type { ToolCallView, ToolResultView } from '@nomix-ai/nomix-tools/presentation'
import type { RpcError, RpcId, RpcRequest } from './rpc.ts'
import type { JobView } from './jobs.ts'
import type { WorkspaceView } from './workspace.ts'

// Client-side consumers take the render-intent vocabulary from the contract;
// nomix-tools remains its owner.
...
export type HostFrame =
   ...
   * owned by `@nomix-ai/nomix-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
