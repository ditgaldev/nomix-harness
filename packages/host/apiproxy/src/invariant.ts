/**
 * Package-owned invariant companion for `@nomix-ai/nomix-host-apiproxy`.
 * @module @nomix-ai/nomix-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-host-apiproxy'
