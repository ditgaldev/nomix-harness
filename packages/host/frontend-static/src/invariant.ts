/**
 * Package-owned invariant companion for `@nomix-ai/nomix-host-frontend-static`.
 * @module @nomix-ai/nomix-host-frontend-static/invariant
 */

import type { Context } from '@nomix-ai/cordis'
import type { InvariantInstaller } from '@nomix-ai/nomix-invariants'

const PACKAGE_NAME = '@nomix-ai/nomix-host-frontend-static'
