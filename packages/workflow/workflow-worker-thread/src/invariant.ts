/**
 * Package-owned invariant companion for `@nomix-ai/nomix-workflow-worker-thread`.
 * @module @nomix-ai/nomix-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-workflow-worker-thread'
