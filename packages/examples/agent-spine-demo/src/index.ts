 ...
 * @module @nomix-ai/nomix-agent-spine-demo
 */

import type { Context } from '@nomix-ai/cordis'
import Timer from '@nomix-ai/cordis-plugin-timer'
...
import SessionTitleService, { type Config as SessionTitleConfig } from '@nomix-ai/nomix-session-title'
import SystemPrompt, { type Config as SystemPromptConfig } from '@nomix-ai/nomix-system-prompt'
import ToolRuntime, { type Config as ToolsConfig } from '@nomix-ai/nomix-tools'
import SkillRegistry, { type Config as SkillRegistryConfig } from '@nomix-ai/nomix-skill'
import * as SkillFileSystem from '@nomix-ai/nomix-skill-filesystem'
import AgentRegistry from '@nomix-ai/nomix-agent'
import GoalService, { type Config as GoalDomainConfig } from '@nomix-ai/nomix-goal'
import * as goalSession from '@nomix-ai/nomix-goal-round-driver'
import * as toolGoal from '@nomix-ai/nomix-tool-goal'
import LocalJobRegistry, { type Config as JobsConfig } from '@nomix-ai/nomix-jobs-local'
import InvariantRegistry, { type Config as InvariantConfig } from '@nomix-ai/nomix-invariants'
...
import * as bashEnv from '@nomix-ai/nomix-shell-env'
