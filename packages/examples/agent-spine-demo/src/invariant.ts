/**
 * Package-owned invariant companion for `@nomix-ai/nomix-agent-spine-demo`.
 * @module @nomix-ai/nomix-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-agent-spine-demo'
