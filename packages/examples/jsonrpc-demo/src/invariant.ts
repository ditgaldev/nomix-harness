/**
 * Package-owned invariant companion for `@nomix-ai/nomix-sdk-jsonrpc-demo`.
 * @module @nomix-ai/nomix-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-sdk-jsonrpc-demo'
