/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-ui-cordis`.
 * @module @nomix-ai/nomix-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-ui-cordis'
