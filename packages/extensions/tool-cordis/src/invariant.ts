/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tool-cordis`.
 * @module @nomix-ai/nomix-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tool-cordis'
