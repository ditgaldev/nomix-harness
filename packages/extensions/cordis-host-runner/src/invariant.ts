/**
 * Package-owned invariant companion for `@nomix-ai/nomix-cordis-host-runner`.
 * @module @nomix-ai/nomix-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-cordis-host-runner'
