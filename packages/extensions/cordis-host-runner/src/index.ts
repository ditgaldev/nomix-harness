 ...
 * @module @nomix-ai/nomix-cordis-host-runner
 */
...
import type { JsonValue } from '@nomix-ai/nomix-session/types'
...
function missingPluginMessage(id: CordisDynamicPluginId): string {
  return `no dynamic plugin "${id}" in this process — it may have been removed or lost on NOMIX restart`
}
