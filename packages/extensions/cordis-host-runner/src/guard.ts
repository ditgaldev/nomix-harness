 ...
 * @module @nomix-ai/nomix-cordis-host-runner/guard
 */

import { Context } from '@nomix-ai/cordis'
import type { Plugin } from '@nomix-ai/cordis'
import { scopeOf } from '@nomix-ai/nomix-scope'
import { assertSupportedJsonSchema, defineTool } from '@nomix-ai/nomix-tools'
...
function sandboxContext(ctx: Context, reportFailure: (error: Error) => void): Context {
  ...
  // (`@nomix-ai/nomix-cordis-client-runner`, whose CTX_VERBS names this one its
