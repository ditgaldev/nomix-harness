...
import type { Loader } from '@nomix-ai/cordis-plugin-loader'
import type {
...
import type { ClientModuleSystem } from '@nomix-ai/nomix-client-modules/client'
import type { SlotRegistry } from '@nomix-ai/nomix-client-runtime/client'
