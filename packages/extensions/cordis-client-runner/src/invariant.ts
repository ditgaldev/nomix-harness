/**
 * Package-owned invariant companion for `@nomix-ai/nomix-cordis-client-runner`.
 * @module @nomix-ai/nomix-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-cordis-client-runner'
