...
import InvariantService from '@nomix-ai/nomix-invariants'
import type {
...
import type { DynamicCordisInvokeResult } from '@nomix-ai/nomix-api-remotes/client'
// Type-only: resolves `ctx.remote` and with it the `$on`/`$dispatch` surface.
import type {} from '@nomix-ai/nomix-api-gateway/client'
