/**
 * Package-owned invariant companion for `@nomix-ai/nomix-terminal-bash`.
 * @module @nomix-ai/nomix-terminal-bash/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-terminal-bash'
