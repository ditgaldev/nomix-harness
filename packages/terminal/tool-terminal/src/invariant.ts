/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tool-terminal`.
 * @module @nomix-ai/nomix-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tool-terminal'
