...
The six generated schemas are listed in the [`nomix-tool-terminal` catalog section](../../../docs/tool-catalog.md#nomix-ainomix-tool-terminal). Their fixed schema tokens are present whenever this plugin is active; agent-scoped tool filtering may hide them.
