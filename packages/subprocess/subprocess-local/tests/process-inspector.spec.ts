...
import type { ProcessInspectorInternals } from '@nomix-ai/nomix-subprocess-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@nomix-ai/nomix-subprocess-local/src/windows-inspector.ts'
