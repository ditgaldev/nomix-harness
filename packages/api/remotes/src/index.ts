...
import type { TypertForwardableEvent } from '@nomix-ai/nomix-typert-protocol'
...
// event vocabulary.
import type {} from '@nomix-ai/nomix-commands/types'
import type {} from '@nomix-ai/nomix-cordis-host-runner/types'
import type {} from '@nomix-ai/nomix-credentials/types'
import type {} from '@nomix-ai/nomix-llm/types'
import type {} from '@nomix-ai/nomix-agent-presets/types'
import type {} from '@nomix-ai/nomix-settings/types'
