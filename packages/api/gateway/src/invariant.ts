/**
 * Package-owned invariant companion for `@nomix-ai/nomix-api-gateway`.
 * @module @nomix-ai/nomix-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-api-gateway'
