...
import type { StorageBackend } from '@nomix-ai/nomix-storage'
import { DomainFacility } from '@nomix-ai/nomix-storage-domain'
import type { DomainChanged } from '@nomix-ai/nomix-storage-domain'
...
async function makeDir(name: string): Promise<string> {
  base ??= await realpath(await mkdtemp(join(tmpdir(), 'nomix-workspace-')))
