/**
 * Package-owned invariant companion for `@nomix-ai/nomix-workspace`.
 * @module @nomix-ai/nomix-workspace/invariant
 */
...
import { WorkspaceId } from '@nomix-ai/nomix-workspace'

const PACKAGE_NAME = '@nomix-ai/nomix-workspace'
