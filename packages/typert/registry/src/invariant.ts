/**
 * Package-owned invariant companion for `@nomix-ai/nomix-typert-registry`.
 * @module @nomix-ai/nomix-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-typert-registry'
