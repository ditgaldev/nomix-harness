/**
 * Package-owned invariant companion for `@nomix-ai/nomix-credentials-local`.
 * @module @nomix-ai/nomix-credentials-local/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-credentials-local'
...
/**
 * No runtime invariant: the Service Definition companion (`nomix-credentials/invariant`) owns the
