/**
 * Package-owned invariant companion for `@nomix-ai/nomix-code-runtime-python`.
 * @module @nomix-ai/nomix-code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-code-runtime-python'
