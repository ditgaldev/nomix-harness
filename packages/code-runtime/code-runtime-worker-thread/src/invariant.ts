/**
 * Package-owned invariant companion for `@nomix-ai/nomix-code-runtime-worker-thread`.
 * @module @nomix-ai/nomix-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-code-runtime-worker-thread'
