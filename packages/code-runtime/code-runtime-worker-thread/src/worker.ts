 ...
 * @module @nomix-ai/nomix-code-runtime-worker-thread/src/worker
 */
...
if (!parentPort) throw new Error('nomix-code-runtime-worker-thread: worker entry loaded outside a worker thread')
