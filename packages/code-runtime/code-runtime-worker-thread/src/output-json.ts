/** JSON string-prefix accounting for the outer-output ledger. @module @nomix-ai/nomix-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@nomix-ai/nomix-code-runtime'
