...
import type { Config } from '@nomix-ai/nomix-code-runtime-worker-thread'
import type { CodeBindingFunction, CodeBindingNamespace, CodeRunResult } from '@nomix-ai/nomix-code-runtime'
...
describe('WorkerThreadCodeRuntime — seam misuse and lifecycle', () => {
  ...
  it('rejects malformed or colliding binding error-class declarations', async () => {
    ...
    await expect(runtime.run({ program: 'return 1', bindings: [{ global: '__nomix_main__', functions: {} }] }))
