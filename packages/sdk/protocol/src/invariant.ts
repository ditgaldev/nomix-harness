/**
 * Package-owned invariant companion for `@nomix-ai/nomix-sdk-protocol`.
 * @module @nomix-ai/nomix-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-sdk-protocol'
