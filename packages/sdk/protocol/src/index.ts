/**
 * Shared wire protocol for the Nomix Harness SDK runtime: the
 ...
 * (`@nomix-ai/nomix-sdk-jsonrpc-server`) serves this protocol; SDK clients
 * (`@nomix-ai/nomix-sdk-client`, the Python SDK) drive it.
 *
 * @module @nomix-ai/nomix-sdk-protocol
 */
