/**
 * Package-owned invariant companion for `@nomix-ai/nomix-sdk-jsonrpc-server`.
 * @module @nomix-ai/nomix-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-sdk-jsonrpc-server'
