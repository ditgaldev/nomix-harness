...
| Package | Role |
|---|---|
| `@nomix-ai/nomix-spill` (this) | Service Definition: abstract service + vocabulary types |
| `@nomix-ai/nomix-spill-local` | Service Provider: private session-scoped files on the host filesystem |
| `@nomix-ai/nomix-spill-policy` | Consumer: the tool-result policy that spills oversized final results |
