...
import type { SaveTextSpill } from '@nomix-ai/nomix-spill'
import LocalSpillStore, { encodeSegment, privateRoot, saveTextFile, sessionDir } from '@nomix-ai/nomix-spill-local'
