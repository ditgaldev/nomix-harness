/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-query-sqlite`.
 * @module @nomix-ai/nomix-session-query-sqlite/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-query-sqlite'
