/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-query`.
 * @module @nomix-ai/nomix-session-query/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-query'
