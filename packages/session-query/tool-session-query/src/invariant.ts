/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tool-session-query`.
 * @module @nomix-ai/nomix-tool-session-query/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tool-session-query'
