...
/**
 * Establish this process's proof that one NOMIX_HOME entry and every ancestor
 ...
 * @param root - absolute `NOMIX_HOME/attachments/v1` root.
...
export async function commitPreparedImageFile(
  ...
  // Establish NOMIX_HOME itself against the filesystem root once per process.
