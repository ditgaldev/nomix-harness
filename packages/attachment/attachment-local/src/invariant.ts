/** Package-owned invariant companion for `@nomix-ai/nomix-attachment-local`. @module @nomix-ai/nomix-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@nomix-ai/cordis'
import type { InvariantInstaller } from '@nomix-ai/nomix-invariants'

const PACKAGE_NAME = '@nomix-ai/nomix-attachment-local'
