...
- Every package here uses the `@nomix-ai/nomix-experimental-*` npm prefix, sets `private: true`, and omits `publishConfig`; the workspace constraints gate enforces these declarations and the nomix release family excludes this directory.
