 ...
 * streams large files, and rejects binary data; line windows belong to `nomix-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module @nomix-ai/nomix-fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from '@nomix-ai/nomix-fs'
