/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tool-str-replace-editor`.
 * @module @nomix-ai/nomix-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tool-str-replace-editor'
