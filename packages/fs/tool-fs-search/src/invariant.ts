/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tool-fs-search`.
 * @module @nomix-ai/nomix-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tool-fs-search'
