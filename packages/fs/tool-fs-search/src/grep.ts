 ...
 *
 * @module @nomix-ai/nomix-tool-fs-search/grep
 */

import type { Context } from '@nomix-ai/cordis'
import { defineTool } from '@nomix-ai/nomix-tools'
import type { GenericCallView, SearchResultView, ToolResult } from '@nomix-ai/nomix-tools'
import type { RetainedItems } from '@nomix-ai/nomix-output-retention'
import type { SpillRef } from '@nomix-ai/nomix-spill'
