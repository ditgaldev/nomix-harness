/**
 * Package-owned invariant companion for `@nomix-ai/nomix-tmux-context`.
 * @module @nomix-ai/nomix-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-tmux-context'
