/**
 * Package-owned invariant companion for `@nomix-ai/nomix-session-reference`.
 * @module @nomix-ai/nomix-session-reference/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-session-reference'
