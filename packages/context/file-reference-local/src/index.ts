 ...
 *
 * @module @nomix-ai/nomix-file-reference-local
 */
...
} from '@nomix-ai/nomix-file-reference'
...
export { FILE_REFERENCE_PROMPT } from '@nomix-ai/nomix-file-reference'
export { activeAtToken, formatFileMention } from '@nomix-ai/nomix-file-reference/grammar'
