/**
 * Package-owned invariant companion for `@nomix-ai/nomix-file-reference-local`.
 * @module @nomix-ai/nomix-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-file-reference-local'
