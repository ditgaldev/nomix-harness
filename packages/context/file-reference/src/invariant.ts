/**
 * Package-owned invariant companion for `@nomix-ai/nomix-file-reference`.
 * @module @nomix-ai/nomix-file-reference/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-file-reference'
