/**
 * Package-owned invariant companion for `@nomix-ai/nomix-agent-instructions`.
 * @module @nomix-ai/nomix-agent-instructions/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-agent-instructions'
