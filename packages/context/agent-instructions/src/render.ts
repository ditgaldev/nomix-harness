 ...
 *
 * @module @nomix-ai/nomix-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$NOMIX_HOME`.
 * Discovery (`$NOMIX_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.nomix/AGENTS.md' || displayPath === '$NOMIX_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
