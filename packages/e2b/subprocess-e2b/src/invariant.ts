/**
 * Package-owned invariant companion for `@nomix-ai/nomix-subprocess-e2b`.
 * @module @nomix-ai/nomix-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-subprocess-e2b'
