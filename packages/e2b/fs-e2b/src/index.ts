...
import type { EntryInfo, Sandbox } from '@nomix-ai/nomix-e2b'

const VERSION_METADATA_KEY = 'nomix-version'
...
export class E2BFileSystem extends FileSystem {
  ...
  private async writeAtomic(
    ...
    const stagingDirectory = posix.join(posix.dirname(targetPath), `.nomix-${randomUUID()}.tmp`)
