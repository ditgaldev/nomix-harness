/**
 * Package-owned invariant companion for `@nomix-ai/nomix-hooks-codex`.
 * @module @nomix-ai/nomix-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-hooks-codex'
