 ...
 * mapping; shared execution and parsing live in `nomix-hook-protocol`.
 ...
 * @module @nomix-ai/nomix-hooks-claude-code
 */
...
import type { PostToolDecision, PreToolDecision, ToolExecution, ToolExecutionResult } from '@nomix-ai/nomix-tools'
import {
  appendHookInvoked,
  appendHookResult,
  createDetachedRuns,
...
} from '@nomix-ai/nomix-hook-protocol'
// Pulls in the declaration-merged subagent events and the identity pairing their
// start/end edges.
import type { SubagentRunId } from '@nomix-ai/nomix-subagent'
