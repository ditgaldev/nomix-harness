/**
 * Package-owned invariant companion for `@nomix-ai/nomix-acp-snapshot`.
 * @module @nomix-ai/nomix-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-acp-snapshot'
