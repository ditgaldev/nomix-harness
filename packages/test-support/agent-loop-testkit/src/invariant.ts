/**
 * Package-owned invariant companion for `@nomix-ai/nomix-agent-loop-testkit`.
 * @module @nomix-ai/nomix-agent-loop-testkit/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-agent-loop-testkit'
