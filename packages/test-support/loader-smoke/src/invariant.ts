/**
 * Package-owned invariant companion for `@nomix-ai/nomix-loader-smoke`.
 * @module @nomix-ai/nomix-loader-smoke/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-loader-smoke'
