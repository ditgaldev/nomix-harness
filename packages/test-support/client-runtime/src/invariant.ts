/**
 * Package-owned invariant companion for `@nomix-ai/nomix-client-test-runtime`.
 * @module @nomix-ai/nomix-client-test-runtime/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-client-test-runtime'
