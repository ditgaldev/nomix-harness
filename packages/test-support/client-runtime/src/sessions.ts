...
import type { AttachmentIdType } from '@nomix-ai/nomix-attachment'
import { createScope, scopeOf, SessionProvideChannel } from '@nomix-ai/nomix-client-runtime/client'
...
import { SESSION_SEARCH_RESULT_LIMIT } from '@nomix-ai/nomix-host-apiproxy/api'
import type { HostObservable, SessionMaybeProvideInfo, SessionProvideInfo } from '@nomix-ai/nomix-client-ui-slots'
