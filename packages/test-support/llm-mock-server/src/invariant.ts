/**
 * Package-owned invariant companion for `@nomix-ai/nomix-llm-mock-server`.
 * @module @nomix-ai/nomix-llm-mock-server/invariant
 */
...
const PACKAGE_NAME = '@nomix-ai/nomix-llm-mock-server'
