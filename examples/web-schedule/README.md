...
This overlay opts one `nomix web` process into Schedule reminders without changing the shipped default Web composition:

```sh
nomix web --patch examples/web-schedule/cordis.yml
```
