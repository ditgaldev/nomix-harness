...
6. If removing prose changes a promised behavior rather than its explanation, use a proposed Agent Note first (follow [nomix-find-simplifications](../nomix-find-simplifications/SKILL.md)).
