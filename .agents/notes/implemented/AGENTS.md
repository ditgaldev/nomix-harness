...
When a shipped note is unlikely to guide future work, archive its complete triplet through [`nomix-archive-agent-notes`](../../skills/nomix-archive-agent-notes/SKILL.md) instead of continuing to maintain it.
