...
- Agents and contributors surveying for simplifications now treat "replace hand-rolled X with package Y" as in-scope output; [nomix-find-simplifications](../../../skills/nomix-find-simplifications/SKILL.md) carries the corresponding guidance.
