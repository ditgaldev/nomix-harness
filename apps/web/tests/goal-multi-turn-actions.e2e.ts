...
import type {} from '@nomix-ai/nomix-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@nomix-ai/nomix-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@nomix-ai/nomix-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@nomix-ai/nomix-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@nomix-ai/nomix-skill-filesystem"}\n',
