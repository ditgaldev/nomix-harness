...
it('boots the built plugin graph and renders a fixture session end to end', async () => {
  ...
  expect(screen.queryByText('NOMIX Local Build')).toBeNull()
  ...
  for (const plugin of ['@nomix-ai/nomix-client-ui-layout', '@nomix-ai/nomix-client-ui-sidebar', '@nomix-ai/nomix-client-ui-conversation', '@nomix-ai/nomix-client-ui-tool']) {
