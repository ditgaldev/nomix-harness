...
import { WEB_SEARCH_MAX_RESULTS } from '@nomix-ai/nomix-tool-web'
import {
...
const QUERIES = ['Nomix Harness snapshot search', 'Nomix Harness multi-query search'] as const
const PROMPT = `Use web_search once with queries ${JSON.stringify(QUERIES)}. Then reply exactly SEARCH_DONE and stop.`
const SEARCH_CREDENTIAL_REF = credentialRef('NOMIX_WEB_SEARCH_E2E_KEY')
