...
/** OS-assigned free port, released before use (the spawned `nomix web` needs a concrete --port). */
 ...
 * `conversationContextKey` in nomix-client-runtime; a drift between them makes
