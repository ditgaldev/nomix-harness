...
// regression the external report asked for (nomix-external/issues#107 →
// nomix-harness#1406): "increase an 800×720 browser regression test and
...
import type {} from '@nomix-ai/nomix-plan-mode'
