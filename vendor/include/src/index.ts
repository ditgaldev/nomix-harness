import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@nomix-ai/cordis-plugin-loader'
 ...
 * (`nomix --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`nomix --dump-config`) so a dump can never drift from what boots. The input
